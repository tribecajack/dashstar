...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    // Set placeholder values directly instead of fetching
    setAverageApy("12.5");  // Example APY value
    setUsdRate("1.00");     // Example USD rate
    setClosestApy("11.8");  // Example closest APY
    setNetApy("10.2");      // Example net APY
    setPrice11("1.001");    // Example virtual price for USDC vault

    // Log placeholder values
    console.log('Using placeholder APY Data:', {
      average_apy: "12.5",
      usd_rate: "1.00",
      closest_apy: "11.8",
      net_apy: "10.2"
    });
  }, []); // Empty dependency array since we're not fetching anymore
